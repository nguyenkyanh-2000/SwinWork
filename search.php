...
$sql = "SELECT EOINumber, job_number, first_name, last_name, gender, birthday, street_address, suburb_town, states, postcode, email, phone, skills, other_skills, status, full_name FROM eoi 
WHERE job_number='".$_POST["query_text"]."' OR first_name='".$_POST["query_text"]."' OR last_name='".$_POST["query_text"]."' OR full_name='".$_POST["query_text"]."'";
...
mysqli_close($conn);
    ...
    $sql = "DELETE FROM eoi WHERE job_number='".$_POST["query_text"]."' OR EOINumber = '".$_POST["query_text"]."'";
    $result = mysqli_query($conn, $sql);
    header("Refresh:0");
}
